...
def show_57_whatsnew(version, oldversion):
    ...
    if oldversion:
        return version >= v57 and oldversion < v57
    else:
        return version >= v57
...
class WhatsnewView(l10n_utils.LangFilesMixin, TemplateView):
    ...
    def get_template_names(self):
        ...
        if channel == 'alpha':
            ...
            # so we'll make it explicit for en-US
            if locale == 'en-US':
                template = 'firefox/whatsnew/whatsnew-57.en-US.html'
            # locale-specific templates for de, en-GB, es-AR, es-CL, es-ES, es-MX,
            # fr, id, pl, pt-BR, ru, zh-CN, and zh-TW. Others get the basic template.
            else:
                template = 'firefox/whatsnew/whatsnew-57.html'
